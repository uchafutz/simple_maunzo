...
<div class="body flex-grow-1 px-3">
        <div class="container-lg">
            ...
            <div class="col-12 d-flex justify-content-end mb-2">
                <a href="{{route('categories.create')}}" class="btn label-btn btn-primary">
                                ...
                                @foreach($categories as $category)
                                    <tr>
                                        <td>{{$loop->iteration}}</td>
                                            <td>
                                             <div class="fs-14">{{$category->name}}</div>
                                        </td>
                                        ...
                                        <td style="width: 80px;">
                                            <div class="hstack gap-2 fs-15 text-center">
                                                <a href="{{route('categories.show', $category)}}" type="success" icon="ri-eye-2-line">show</a>
